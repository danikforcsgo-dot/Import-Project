...
TOKENS = [
    ...
    'ARB/USDT:USDT', 'TRX/USDT:USDT', 'FIL/USDT:USDT', 'ATOM/USDT:USDT',
    'HBAR/USDT:USDT', 'XLM/USDT:USDT', 'ENA/USDT:USDT', 'LDO/USDT:USDT',
    'CRV/USDT:USDT', 'GMX/USDT:USDT', 'PENDLE/USDT:USDT', 'RUNE/USDT:USDT',
    'IMX/USDT:USDT', 'JUP/USDT:USDT', 'PYTH/USDT:USDT', 'POL/USDT:USDT',
    'SEI/USDT:USDT', 'FET/USDT:USDT', 'RENDER/USDT:USDT', 'ONDO/USDT:USDT',
    'TIA/USDT:USDT', 'ALGO/USDT:USDT', 'ICP/USDT:USDT', 'WLD/USDT:USDT',
    'WIF/USDT:USDT', 'FLOKI/USDT:USDT', '1000BONK/USDT:USDT', '1000PEPE/USDT:USDT',
    'AXS/USDT:USDT', 'GRASS/USDT:USDT', 'TAO/USDT:USDT', 'ENJ/USDT:USDT',
    'KAITO/USDT:USDT', 'BERA/USDT:USDT', 'STX/USDT:USDT', 'KAS/USDT:USDT',
    'W/USDT:USDT', 'ETHFI/USDT:USDT', 'IO/USDT:USDT', 'DRIFT/USDT:USDT',
]
